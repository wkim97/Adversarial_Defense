...
def train(selected_class, gaussian):
    gaussian_model_path = './noise_models/gaussian/noise_models/{}'.format(selected_class)
    pgd_model_path = './noise_models/pgd_attacked/noise_models/{}'.format(selected_class)
    gaussian_training_path = './noise_models/gaussian/training_steps/{}'.format(selected_class)
    pgd_training_path = './noise_models/pgd_attacked/training_steps/{}'.format(selected_class)
    gaussian_dataset_path = './noise/gaussian/noise/{}'.format(selected_class)
    pgd_dataset_path = './noise/pgd_attacked/noise/{}'.format(selected_class)
    gaussian_generator_path = './gan_models/{}/gaussian_generator.pkl'.format(selected_class)
    gaussian_discriminator_path = './gan_models/{}/gaussian_discriminator.pkl'.format(selected_class)
    pgd_generator_path = './gan_models/{}/pgd_generator.pkl'.format(selected_class)
    pgd_discriminator_path = './gan_models/{}/pgd_discriminator.pkl'.format(selected_class)
